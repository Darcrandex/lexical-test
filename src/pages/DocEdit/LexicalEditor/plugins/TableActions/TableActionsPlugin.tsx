/**
 * @description 表格组件单元格操作菜单插件
 * @description 目前功能还不完善
 * @author darcrand
 */
...
function TableActionMenu({
  ...
  return createPortal(
    <div
      className='table-actions-plugin__menus'
      ref={dropDownRef}
      onClick={(e) => {
        e.stopPropagation()
      }}
    >
      <p className='table-actions-plugin__menu-item' onClick={() => insertTableRowAtSelection(false)}>
        向上插入行
      </p>
      <p className='table-actions-plugin__menu-item' onClick={() => insertTableRowAtSelection(true)}>
        向下插入行
      </p>
      <hr />
      <p className='table-actions-plugin__menu-item' onClick={() => insertTableColumnAtSelection(false)}>
        向左插入列
      </p>
      <p className='table-actions-plugin__menu-item' onClick={() => insertTableColumnAtSelection(true)}>
        向右插入列
      </p>
      <hr />
      <p className='table-actions-plugin__menu-item' onClick={() => deleteTableColumnAtSelection()}>
        删除列
      </p>
      <p className='table-actions-plugin__menu-item' onClick={() => deleteTableRowAtSelection()}>
        删除行
      </p>
      <p className='table-actions-plugin__menu-item' onClick={() => deleteTableAtSelection()}>
        删除表格
      </p>
      <hr />
...
function TableCellActionMenuContainer({ anchorElem }: { anchorElem: HTMLElement }): JSX.Element {
  ...
  return (
    <div className='table-actions-plugin__cell-menu-container' ref={menuButtonRef}>
      {tableCellNode != null && (
        <>
          <Button
            shape='circle'
...
export function TableActionMenuPlugin({ anchorElem = document.body }: { anchorElem?: HTMLElement }): ReactPortal {
